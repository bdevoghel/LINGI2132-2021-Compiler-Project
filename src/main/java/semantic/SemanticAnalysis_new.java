...
import scopes_new.*;
import static ast_new.BinaryOperator.*;
import static types_new.Type.*;
 ...
 * </ul>
 */
public final class SemanticAnalysis_new
{
    // =============================================================================================
...
//    private KneghelNode inferenceContext;
//
...
//    private int argumentIndex;
    ...
    private SemanticAnalysis_new(Reactor reactor) {
        this.R = reactor;
    }
    ...
    public static Walker<KneghelNode> createWalker (Reactor reactor)
    {
        ...
        SemanticAnalysis_new analysis = new SemanticAnalysis_new(reactor);
...
//
////            final KneghelNode context = this.inferenceContext;
//
    ...
    private void funCall (FunCallNode node)
    {
        ...
        R.rule(node, "type")
                ...
                .by(r -> {
                    ...
                    // TODO maybe add check for function number of arguments
                });
...
//                        }
//                    });
            R.set(node, "value", UNKNOWN_TYPE); // TODO change to returned type
        }
    }
