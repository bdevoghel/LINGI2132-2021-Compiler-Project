...
/**
 * Test class largely inspired by Valentin Lemaire to implement a testing class similar to what Uranium and Autumn propose
 */

public class InterpreterTests extends TestFixture {
    ...
    public void testTest() {
        successExpect("class Hello { fun world(a) {return a+1} fun main(args) {a=1 return world(a)} }", 1);
    }
