...
//        successExpect("a = \"a\"+\"a\" - \"a\"", new AssignmentNode(new IdentifierNode("a"), new BinaryExpressionNode(new StringNode("a"), ADD, new StringNode("a"))));
    ...
    public void testFunctions() {
        ...
        /*successExpect("fun foo() { a[0] = 2 \n return a[0]}",
                new FunctionStatementNode(
                        new IdentifierNode("foo"),
                        new FunctionArgumentsNode(Collections.emptyList()),
                        Arrays.asList(new AssignmentNode(new ArrayMapAccessNode(new IdentifierNode("a"), new IntegerNode(0)), new IntegerNode(2))),
                        new ArrayMapAccessNode(new IdentifierNode("a"), new IntegerNode(0))));*/ // TODO make this work
    }
